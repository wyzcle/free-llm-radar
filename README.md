...
> **只收录"斩杀线"之上的模型**：商业旗舰家族（GPT / Claude / Gemini / Grok / DeepSeek V3 / Kimi / GLM / Qwen-Max / 豆包 等）或参数量 ≥100B 的开源旗舰；
> 小模型与本地部署工具已过滤（全量数据仍在 [data/freebies.json](data/freebies.json)）。
...
最后更新：**2026-09-03 08:19 (UTC+8)** ｜ 有效条目：**39** ｜ 48h 内新增：**39** ｜ 来源：linux.do(15)、mnfst/awesome-free-llm-apis(13)、nejib1/Free-LLM(8)、official-pages(2)、openrouter(1)
